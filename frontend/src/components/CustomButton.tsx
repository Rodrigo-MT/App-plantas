...
export default function CustomButton({
  ...
  // hover state is not used directly; we keep handlers for web hover effects but avoid unused state
  ...
  const handleMouseEnter = () => {
    if (!disabled) {
      // intentionally no local hover state to avoid unused variable warnings
